...
2. [History and Design Philosophy](#history-and-design-philosophy)
3. [Why Learn Malbolge?](#why-learn-malbolge)
4. [How Malbolge Works](#how-malbolge-works)
5. [The Eight Instructions](#the-eight-instructions)
6. [Memory Model and Ternary Arithmetic](#memory-model-and-ternary-arithmetic)
7. [Example Programs](#example-programs)
8. [Understanding Program Generation](#understanding-program-generation)
...
2. **Complex Addressing**: Calculating `(C + memory[C]) mod 94` mentally is impractical
3. **Crazy Operation**: No intuitive mapping from inputs to outputs
4. **State Explosion**: Each instruction creates branching possibilities
...
- [Lou Scheffer's Programming in Malbolge](http://www.lscheffer.com/malbolge.shtml) - Deep technical analysis
